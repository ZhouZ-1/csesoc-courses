  ...
  return (
    <>
      <button
        ...
        onClick={async () => {
          await navigator.clipboard?.writeText(`/course join course:${course}`);
          setIsShowing(true);
          setTimeout(() => {
            setIsShowing(false);
          }, 5000);
      ...
      >
        <button className="fixed bottom-10 left-0 right-0 z-10">
          <a
            className="bg-[#36393f] rounded-md p-4 mx-auto text-center text-xs lg:text-lg w-fit select-none cursor-pointer font-discord shadow-xl"
